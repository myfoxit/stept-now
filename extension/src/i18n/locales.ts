/**
 * The locales Stept ships. Mirrors `frontend/src/i18n/locales.ts` and
 * `widget/src/i18n/locales.ts`; `scripts/check-i18n.mjs` fails the build if the
 * copies drift.
 */
 ...
 * so a user in Austria gets German rather than English.
 */
